<template>
  ...
  <div class="lekton-regular about-container justify">
    <p class="p-2">
      I'm a 24-year-old Computer Engineering student. I got a 4 out of 5 for my Master's thesis. One could say I am
    ...
    <p class="p-2">
      ...
      looked like absolute dog shit). I have worked with Vue during my work at this one company (they make a bunch of
    ...
    <p class="p-2">
      ...
      much
      text. My website just is not made for your teeny tiny attention span and that's okay. You don't have to be here :)
    </p>
    <p class="p-2">
